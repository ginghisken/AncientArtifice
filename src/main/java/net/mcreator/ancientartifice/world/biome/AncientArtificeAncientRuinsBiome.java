...
package net.mcreator.ancientartifice.world.biome;
...
public class AncientArtificeAncientRuinsBiome extends AncientArtificeModElements.ModElement {
	public static Biome biome;

	public AncientArtificeAncientRuinsBiome(AncientArtificeModElements instance) {
		super(instance, 2);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6982951).setWaterColor(-6608432).setWaterFogColor(-10669430)
						.withSkyColor(-6982951).withFoliageColor(-4100579).withGrassColor(-5872108)
						.setAmbientSound(
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.STONE_BRICKS.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.GRAVEL.getDefaultState()),
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.1f).scale(0.7f).temperature(0.5f)
						.downfall(0.3f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("ancient_artifice:ancient_artifice_ancient_ruins"));
			}
		}
	}
	...
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)),
				BiomeDictionary.Type.OVERWORLD, BiomeDictionary.Type.WASTELAND);
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("ancient_artifice_ancient_ruins_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("ancient_artifice_ancient_ruins_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("ancient_artifice_ancient_ruins_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
